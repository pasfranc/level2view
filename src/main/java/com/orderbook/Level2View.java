...
/*
 * Implement the below interface of a Level 2 view on an electronic 
	order book (see https://en.wikipedia.org/wiki/Order_book_(trading) ).
 *
...
public interface Level2View {
	...
	// When an aggressor order crosses the spread, it will be matched with an
	// existing resting order, causing a trade.
